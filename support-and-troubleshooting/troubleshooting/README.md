...
{% content-ref url="plugin-checks.md" %}
[plugin-checks.md](plugin-checks.md)
{% endcontent-ref %}

{% content-ref url="system-checks.md" %}
[system-checks.md](system-checks.md)
{% endcontent-ref %}

{% content-ref url="things-to-try.md" %}
[things-to-try.md](things-to-try.md)
{% endcontent-ref %}
